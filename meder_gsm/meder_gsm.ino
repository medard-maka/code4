...
char phone_no[]="+243971400864"; //change +92 with country code and 3378655465 with phone number to sms
...
pinMode(bt_C, INPUT); // declare bt_C as input
...
if(digitalRead (bt_M) == 1){sendSMS(phone_no,"Bonjour Medard Maka");}
if(digitalRead (bt_C) == 1){callUp(phone_no);}
